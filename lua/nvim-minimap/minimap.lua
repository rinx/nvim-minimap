local _2afile_2a = "fnl/nvim-minimap/minimap.fnl"
local _0_
do
...
do
  ...
  local function __3ebraille0(...)
    local function _3_(acc, x)
      return (acc + x)
    end
    return braille_table[a.inc(a.reduce(_3_, 0, {...}))]
  end
  v_0_ = __3ebraille0
  local t_0_ = (_0_)["aniseed/locals"]
  t_0_["->braille"] = v_0_
...
do
  ...
  do
    local v_0_0
    local function minimap0(buf, _3_)
      local _arg_0_ = _3_
...
-- (->braille (braille-idx 0 0)) (->braille (braille-idx 0 0) (braille-idx 1 0) (braille-idx 0 2)) (scale 0.25 table: 0x7fbc0617a220) (->chunks 4 table: 0x7fbc06209658) (->line table: 0x7fbc062b0010) (minimap (vim.fn.bufnr %))
return nil