package.preload["nvim-minimap.aniseed.fennel.repl"] = package.preload["nvim-minimap.aniseed.fennel.repl"] or function(...)
  local utils = require("nvim-minimap.aniseed.fennel.utils")
  local parser = require("nvim-minimap.aniseed.fennel.parser")
  local compiler = require("nvim-minimap.aniseed.fennel.compiler")
  local specials = require("nvim-minimap.aniseed.fennel.specials")
...
package.preload["nvim-minimap.aniseed.fennel.view"] = package.preload["nvim-minimap.aniseed.fennel.view"] or function(...)
...
package.preload["nvim-minimap.aniseed.fennel.specials"] = package.preload["nvim-minimap.aniseed.fennel.specials"] or function(...)
  local utils = require("nvim-minimap.aniseed.fennel.utils")
  local view = require("nvim-minimap.aniseed.fennel.view")
  local parser = require("nvim-minimap.aniseed.fennel.parser")
  local compiler = require("nvim-minimap.aniseed.fennel.compiler")
  ...
  local function metadata_only_fennel(modname)
    if ((modname == "nvim-minimap.aniseed.fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
...
package.preload["nvim-minimap.aniseed.fennel.compiler"] = package.preload["nvim-minimap.aniseed.fennel.compiler"] or function(...)
  local utils = require("nvim-minimap.aniseed.fennel.utils")
  local parser = require("nvim-minimap.aniseed.fennel.parser")
  local friend = require("nvim-minimap.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
  local scopes = {}
...
package.preload["nvim-minimap.aniseed.fennel.friend"] = package.preload["nvim-minimap.aniseed.fennel.friend"] or function(...)
  local function ast_source(ast)
    local m = getmetatable(ast)
    return ((m and m.line and m) or (("table" == type(ast)) and ast) or {})
  end
...
package.preload["nvim-minimap.aniseed.fennel.parser"] = package.preload["nvim-minimap.aniseed.fennel.parser"] or function(...)
  local utils = require("nvim-minimap.aniseed.fennel.utils")
  local friend = require("nvim-minimap.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
...
local utils = nil
package.preload["nvim-minimap.aniseed.fennel.utils"] = package.preload["nvim-minimap.aniseed.fennel.utils"] or function(...)
...
utils = require("nvim-minimap.aniseed.fennel.utils")
local parser = require("nvim-minimap.aniseed.fennel.parser")
local compiler = require("nvim-minimap.aniseed.fennel.compiler")
local specials = require("nvim-minimap.aniseed.fennel.specials")
local repl = require("nvim-minimap.aniseed.fennel.repl")
local view = require("nvim-minimap.aniseed.fennel.view")
...
do
  ...
  local module_name = "nvim-minimap.aniseed.fennel.macros"
  local _ = nil
  local function _0_()
    return mod
  end
