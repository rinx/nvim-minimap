local _0_0
do
  local name_0_ = "nvim-minimap.aniseed.env"
  local module_0_
  do
...
local function _1_(...)
  ...
  local function _1_()
    return {autoload("nvim-minimap.aniseed.nvim")}
  end
  ok_3f_0_, val_0_ = pcall(_1_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {autoload = {nvim = "nvim-minimap.aniseed.nvim"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "nvim-minimap.aniseed.env"
  ...
  do
    ...
    local function init0(opts)
      ...
      if ((false ~= opts0.compile) or os.getenv("ANISEED_ENV_COMPILE")) then
        local compile = require("nvim-minimap.aniseed.compile")
        local fennel = require("nvim-minimap.aniseed.fennel")
