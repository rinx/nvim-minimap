local _0_0
do
  local name_0_ = "nvim-minimap.aniseed.dotfiles"
  local module_0_
  do
...
local function _1_(...)
  ...
  local function _1_()
    return {autoload("nvim-minimap.aniseed.compile"), autoload("nvim-minimap.aniseed.fennel"), autoload("nvim-minimap.aniseed.nvim")}
  end
  ok_3f_0_, val_0_ = pcall(_1_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {autoload = {compile = "nvim-minimap.aniseed.compile", fennel = "nvim-minimap.aniseed.fennel", nvim = "nvim-minimap.aniseed.nvim"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "nvim-minimap.aniseed.dotfiles"
