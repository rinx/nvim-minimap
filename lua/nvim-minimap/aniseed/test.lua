local _0_0
do
  local name_0_ = "nvim-minimap.aniseed.test"
  local module_0_
  do
...
local function _1_(...)
  ...
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {autoload = {a = "nvim-minimap.aniseed.core", nvim = "nvim-minimap.aniseed.nvim", str = "nvim-minimap.aniseed.string"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "nvim-minimap.aniseed.test"
